          ...
          <div className="h-full w-full px-5 py-4 flex flex-col justify-between">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                {/* Avatar / icon circle */}
                <div className="h-9 w-9 rounded-full bg-neutral-300 dark:bg-neutral-800 flex items-center justify-center flex-shrink-0">
                  {Icon ? (
                    <Icon className="h-4 w-4 text-neutral-400 dark:text-neutral-600" />
                  ) : (
                    <div className="h-4 w-4 rounded-full bg-neutral-400 dark:bg-neutral-700" />
                  )}
                </div>
                <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                  <div className="h-3.5 w-28 rounded bg-neutral-300 dark:bg-neutral-800" />
                  <div className="h-2.5 w-40 rounded bg-neutral-300/80 dark:bg-neutral-800/80" />
                </div>
              </div>
              {/* Time badge */}
              <div className="h-5 w-14 rounded-full bg-neutral-300/90 dark:bg-neutral-800/90 flex-shrink-0" />
            </div>

            {/* Bottom row — pills + status */}
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-1.5">
                <div className="h-4 w-16 rounded-full bg-neutral-300/90 dark:bg-neutral-800/90" />
                <div className="h-1 w-1 rounded-full bg-neutral-400 dark:bg-neutral-700" />
                <div className="h-4 w-12 rounded-full bg-neutral-300/80 dark:bg-neutral-800/80" />
              </div>
