  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 outline-none cursor-pointer focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:!transition-none aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-surface-hover text-foreground-1 shadow-xs hover:bg-surface-active hover:border-border-strong dark:bg-surface dark:text-foregrund-1 dark:hover:bg-surface dark:hover:border-border-strong",
        secondary:
        ...
        info:
          "border border-blue-500 bg-transparent text-blue-600 shadow-xs hover:bg-blue-50 hover:border-blue-600 focus-visible:ring-blue-500/20 dark:text-blue-400 dark:border-blue-400 dark:hover:bg-blue-950/30",
      },
      size: {
