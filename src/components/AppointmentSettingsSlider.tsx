...
import { ArrowLeft, Calendar, Clock, Bell, Shield, ChevronsUpDown, Check } from 'lucide-react';
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center p-2 border-b bg-card/50 relative">
            ...
            <h2 className="text-lg font-semibold text-foreground absolute left-1/2 transform -translate-x-1/2">Appointment Settings</h2>
          </div>
