...
import { Globe, Palette, Link2, Eye, Share2, ChevronsUpDown, Check, Copy } from 'lucide-react';
...
const WebsiteDomainSlider: React.FC<WebsiteDomainSliderProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <form id="website-domain-form" onSubmit={handleSubmit} className="max-w-md mx-auto">
