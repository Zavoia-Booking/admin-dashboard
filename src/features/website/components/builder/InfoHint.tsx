...
/** Just the pulsing primary Info glyph — use inline (e.g. beside a section name in the list) to flag
...
export function InfoPulse({ className }: { className?: string }) {
  return (
    <span className={cn("relative flex h-3.5 w-3.5 shrink-0", className)}>
      <span
        className="motion-safe:animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-20"
...
/**
 * The app's standard "heads-up / required" field cue: the pulsing Info glyph beside helper text, rendered
