...
const StepBusinessInfo = forwardRef<StepHandle, StepProps>(({ data, onValidityChange }, ref) => {
  ...
  const { control, register, watch, setValue, reset, trigger, setError, formState: { errors, isValid: formIsValid } } = useForm<WizardData>({
    defaultValues: data,
    mode: 'onChange',
  });
  ...
  const { field: businessNameField, fieldState: businessNameState } = useController<any>({
  ...
  useEffect(() => {
    // Only reset when wizard has finished loading (prevents validation flash)
  ...
  }, [data, reset, trigger, setError, isWizardLoading]);
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input 
                ...
                autoComplete="email"
                {...register('businessInfo.email' as any, isWizardLoading ? {} : {
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input 
                ...
                autoComplete="tel"
                inputMode="tel"
                {...register('businessInfo.phone' as any, isWizardLoading ? {} : {
