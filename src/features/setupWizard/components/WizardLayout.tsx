          ...
          <div className="grid grid-cols-1 md:grid-cols-12">
            ...
            <section className="md:col-span-8 px-4 md:px-6 pt-0 pb-8 md:pb-4 ">
                  ...
                  <div className="flex items-center gap-2">
                    {onSave && (
                      <Button
                        ...
                        onClick={onSave}
                        disabled={isLoading}
                        className="relative gap-2 cursor-pointer h-8 w-28"
                      >
                        {isLoading ? (
                          <>
                ...
                <div className="hidden md:flex items-center justify-end">
                  ...
                  {onClose && (
                    <button
                      aria-label="Close"
                      onClick={onClose}
                      className="inline-flex h-8 w-8 items-center justify-center rounded-md hover:bg-muted cursor-pointer ml-2"
                    >
                      <X className="h-6 w-6" />
                    </button>
                  )}
              ...
              <div className="mb-4 pt-0 md:pt-4">
                <h2 className="text-lg font-semibold text-foreground pt-6 md:pt-0">
                  {title}
                </h2>
                {subtitle && (
              ...
              <div className="rounded-lg md:border bg-white p-0 md:p-4 py-4 min-h-[500px]">
                {children}
              </div>
