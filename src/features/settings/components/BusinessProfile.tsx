...
import { Copy, Building2, Mail, Clock, Shield, ChevronsUpDown, Check } from 'lucide-react';
...
const BusinessProfile: React.FC = () => {
  ...
  return (
    <form id="business-info-form" onSubmit={handleSubmit} className="max-w-2xl mx-auto">
