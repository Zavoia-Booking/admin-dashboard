...
import { MobileDayEventCard } from "../mobile/MobileDayEventCard.tsx";
...
export const AppointmentGroupDialog: FC<AppointmentGroupDialogProps> = ({
  ...
  // Already-on-day-view: the "View day" action is a no-op navigation, so hide it.
  const showViewDayAction = calendarViewMode !== AppointmentViewMode.DAY;
  ...
  const body = (
    <>
      ...
      {/* Footer — hidden when already on day view (no useful navigation) */}
      {showViewDayAction && (
