...
// Location selection
export const selectLocationAction = createAction("ASSIGNMENTS/SELECT_LOCATION")<
  number | null
>();
...
export const fetchLocationFullAssignmentAction = createAsyncAction(
  ...
  number | { locationId: number; skipLoading?: boolean },
  LocationFullAssignment,
  { message: string }
>();
...
export const updateLocationBundlesAction = createAsyncAction(
  "ASSIGNMENTS/UPDATE_LOCATION_BUNDLES_REQUEST",
  "ASSIGNMENTS/UPDATE_LOCATION_BUNDLES_SUCCESS",
  "ASSIGNMENTS/UPDATE_LOCATION_BUNDLES_FAILURE",
)<UpdateLocationBundlesPayload, void, { message: string }>();
...
export const fetchStaffServicesAtLocationAction = createAsyncAction(
  ...
  { locationId: number; userId: number },
  StaffServicesAtLocation,
  { message: string }
>();
...
export const updateTeamMemberStatsAction = createAction(
  "ASSIGNMENTS/UPDATE_TEAM_MEMBER_STATS",
)<{
  userId: number;
