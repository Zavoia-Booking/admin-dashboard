...
import type { LocationBundle } from "../../types";

interface LocationBundleRowProps {
  bundle: LocationBundle;
  currency?: string;
}

export function LocationBundleRow({
  bundle,
  currency = "USD",
}: LocationBundleRowProps) {
  ...
  return (
    <div className="group flex items-start rounded-lg gap-4 px-4 py-4 md:py-3 w-full border border-border-strong md:border-border bg-white dark:bg-surface hover:border-border-strong">
