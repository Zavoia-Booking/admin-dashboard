...
interface AboutEditorProps {
  ...
  /** True when the About section is visible on the page → a headline is required to publish. */
  required?: boolean;
}
 ...
 * so the split stays unambiguous. While the section is shown the headline is required (a pulsing InfoHint
