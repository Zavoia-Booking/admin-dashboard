 ...
 * the publish-time "headline required" check, so they can never disagree on where the split falls.
 */
...
/** The headline alone (first paragraph), trimmed — used by publish validation to require it when shown. */
