 ...
 * tagline and cover image at the top of the public page, plus the show/hide controls for the intro
 * line and (once the business has reviews) the rating. The booking button copy is fixed. Logo, slug
