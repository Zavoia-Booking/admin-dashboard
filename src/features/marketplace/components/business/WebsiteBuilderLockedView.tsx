...
/**
 * Upgrade/locked view rendered in place of the WebsiteBuilderTab when the plan lacks the
 ...
 * layout — the business's own name/logo/hero/locations — so the upsell shows exactly what
 * publishing would look like rather than a generic mockup.
 *
