          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              <h3 className="font-semibold text-lg text-foreground-1 tracking-tight">
                {isVisible ? "Listing is Public" : "Listing is Private"}
              </h3>
            ...
            <p className="text-sm text-foreground-3 dark:text-foreground-2 max-w-[400px] leading-relaxed">
              {isVisible
                ? "Your business is currently visible to all users browsing the marketplace."
                : "Your business is hidden. Customers cannot find or book your services via the marketplace."}
            </p>
          </div>
        </div>
