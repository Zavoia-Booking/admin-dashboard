          ...
          {isMobile ? (
            ...
            >
              <DrawerTrigger asChild>
                <Button
                  ...
                  variant="outline"
                  rounded="full"
                  className="h-9 w-full md:w-auto px-3 py-1.5 gap-1.5 text-xs font-medium border border-dashed border-border-strong dark:bg-transparent dark:hover:bg-neutral-900 dark:border-border-strong"
                >
              ...
              >
                <DrawerTitle className="sr-only">
                  {text("addService.form.category.managePopoverTitle")}
                </DrawerTitle>
                <DrawerDescription className="sr-only">
                  {text("addService.form.category.managePopoverDescription")}
                </DrawerDescription>
            ...
            >
              ...
              <PopoverContent
                ...
                sideOffset={8}
                onOpenAutoFocus={(event) => event.preventDefault()}
                className="w-[520px] max-h-128 overflow-y-auto scrollbar-hide p-4 bg-surface border border-border shadow-md rounded-xl space-y-4"
              >
                <CategorySection
                  categoryId={manageCategoryId}
                  categoryName={manageCategoryName}
