...
import { updateBundleAction, deleteBundleAction } from "../../../bundles/actions";
...
const EditBundleSlider: React.FC<EditBundleSliderProps> = ({
  ...
  const validateBundleName = (value: string): string | true => {
    ...
    if (v.length < 2) return text("bundles.editBundle.validation.nameMinLength");
    if (v.length > 100) return text("bundles.editBundle.validation.nameMaxLength");
    return true;
  };
  ...
  const validateDescription = (value: string): string | true => {
    ...
    const v = value.trim();
    if (v.length > 500) return text("bundles.editBundle.validation.descriptionMaxLength");
    return true;
  };
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-5">
                  <TextField
                    ...
                    placeholder={text("bundles.editBundle.form.name.placeholder")}
                    required
                    id="bundle-name"
                    maxLength={100}
                    icon={Package}
                  ...
                  <TextareaField
                    ...
                    placeholder={text("bundles.editBundle.form.description.placeholder")}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-center">
                      ...
                      >
                        ...
                        {text("bundles.editBundle.manageServices")}
                      </Button>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl border border-border bg-surface-hover/50 dark:bg-neutral-900/30 p-4">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2">
                        {selectedServices.length} {selectedServices.length === 1 ? text("bundles.editBundle.pricing.service") : text("bundles.editBundle.pricing.services")}
                      </p>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <PriceField
                            ...
                            label={text("bundles.editBundle.form.fixedPrice.label")}
                            placeholder="0.00"
                            required
                            id="fixed-price"
                            min={0}
                              ...
                              <div className="flex items-center justify-between pt-2 border-t border-border/50">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-xs font-medium text-foreground-2">
                                    {priceDifference < 0 
                                      ? text("bundles.editBundle.pricing.savings")
                                      : text("bundles.editBundle.pricing.increase")}
                                  </span>
                                </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          <TextField
                            ...
                            label={text("bundles.editBundle.form.discountPercentage.label")}
                            placeholder={text("bundles.editBundle.form.discountPercentage.placeholder")}
                            required
                          />
                          <p className="text-xs text-foreground-3 dark:text-foreground-2 mt-1">
                            {text("bundles.editBundle.form.discountPercentage.help")}
                          </p>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text("bundles.editBundle.form.priceType.sumDescription")}
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text("bundles.editBundle.form.priceType.fixedDescription")}
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text("bundles.editBundle.form.priceType.discountDescription")}
                      </p>
                    </div>
                  </button>
                </div>
