...
const AddBundleSlider: React.FC<AddBundleSliderProps> = ({
  ...
  const handleApplyServices = (newServiceIds: number[]) => {
    setValue("serviceIds", newServiceIds, {
      shouldValidate: true,
      shouldTouch: true,
    });
  };
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-5">
                  <TextField
                    ...
                    placeholder={text(
                      "bundles.addBundle.form.name.placeholder",
                    )}
                    required
                    id="bundle-name"
                    maxLength={100}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-start">
                      ...
                      >
                        ...
                        <span>{text("bundles.addBundle.manageServices")}</span>
                      </Button>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text(
                          "bundles.addBundle.form.priceType.sumDescription",
                        )}
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text(
                          "bundles.addBundle.form.priceType.fixedDescription",
                        )}
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-foreground-3 dark:text-foreground-2 leading-relaxed">
                        {text(
                          "bundles.addBundle.form.priceType.discountDescription",
                        )}
                      </p>
                    </div>
                  </button>
                      ...
                      <div className="rounded-xl border border-border bg-surface-hover/50 dark:bg-neutral-900/30 p-4">
                        ...
                        <p className="text-xs bg-secondary w-fit rounded-full px-3 py-1 text-foreground-1 dark:text-foreground-2">
                          ...
                          {selectedServices.length === 1
                            ? text("bundles.addBundle.pricing.service")
                            : text("bundles.addBundle.pricing.services")}
                        </p>
                      </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <PriceField
                              ...
                              label={text(
                                "bundles.addBundle.form.fixedPrice.label",
                              )}
                              placeholder="0.00"
                              required
                              id="fixed-price"
                                  ...
                                  <div className="flex items-center justify-between pt-2 border-t border-border/50">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-xs font-medium text-foreground-2">
                                        {priceDifference < 0
                                          ? text(
                                              "bundles.addBundle.pricing.savings",
                                            )
                                          : text(
                                              "bundles.addBundle.pricing.increase",
                                            )}
                                      </span>
                                    </div>
                                    <span
